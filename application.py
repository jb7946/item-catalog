...
# Connect to the Database and define engine
...
def editCatItem(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('item-edit.html', category_id=category_id,
...
def deleteCatItem(category_id, item_id):
    ...
    if request.method == 'POST':
        ...
        return render_template('item-remove.html', item=itemToDelete)
