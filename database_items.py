...
session = DBSession()
# Add my info
User1 = User(name="John Bitner", email="jorshiac@gmail.com")
session.add(User1)
session.commit()
...
itemc1i1 = Item(user_id=1, name="Beef Pho", description="Classic Pho with beef.",
             category=category1)
...
itemc1i2 = Item(user_id=1, name="Vegan Pho",
             description="Classic Pho with plant based ingredients.", category=category1)

session.add(itemc1i2)
session.commit()

itemc1i3 = Item(user_id=1, name="Eggrolls",
...
category2 = Category(user_id=1, name="Lincoln Steak House")

session.add(category2)
session.commit()

# Add Item 1 under Catalog 2 for the item catalog project
itemc2i1 = Item(user_id=1, name="Sirloin Steak",
...
itemc2i2 = Item(user_id=1, name="Filet Mignon",
             description="Succulent 8oz cut grilled to perfection.", category=category2)

session.add(itemc2i2)
session.commit()

# Add Item 3 under Catalog 2 for the item catalog project
itemc2i3 = Item(user_id=1, name="Rib Eye",
             description="Skillfully cut slice to gobble your hunger.", category=category2)
...
category3 = Category(user_id=1, name="Jax Grille")

session.add(category3)
session.commit()

# Add Item 1 under Catalog 3 for the item catalog project
itemc3i1 = Item(user_id=1, name="Hamburger",
             description="Classic Burger on bun.", category=category3)

session.add(itemc3i1)
session.commit()

# Add Item 2 under Catalog 3 for the item catalog project
itemc3i2 = Item(user_id=1, name="Cheeseburger", description="Classic Burger with cheese.",
             category=category3)
...
itemc3i3 = Item(user_id=1, name="Basic Salad",
             description="Quick and easy salad.", category=category3)

session.add(itemc3i3)
session.commit()

# Add Category 4 for the item catalog project
category4 = Category(user_id=1, name="Seafood Chest")

session.add(category4)
session.commit()

# Add Item 1 under Catalog 4 for the item catalog project
itemc4i1 = Item(user_id=1, name="Flounder",
...
itemc4i2 = Item(user_id=1, name="Cod",
             description="Great taste for less.", category=category4)

session.add(itemc4i2)
session.commit()

# Add Item 3 under Catalog 4 for the item catalog project
itemc4i3 = Item(user_id=1, name="Salmon",
             description="Heart Healthy with every bite.", category=category4)

session.add(itemc4i3)
session.commit()

# Add Category 5 for the item catalog project
category5 = Category(user_id=1, name="American Buffet")

session.add(category5)
session.commit()

# Add Item 1 under Catalog 5 for the item catalog project
itemc5i1 = Item(user_id=1, name="Open Buffet",
...
itemc5i2 = Item(user_id=1, name="Steak",
...
itemc5i3 = Item(user_id=1, name="Chicken",
...
category6 = Category(user_id=1, name="Simple Sandwiches")

session.add(category6)
session.commit()

# Add Item 1 under Catalog 6 for the item catalog project
itemc6i1 = Item(user_id=1, name="Ham and Cheese", description="Just the basics.",
             category=category6)
...
itemc6i2 = Item(user_id=1, name="Turkey on Rye",
...
itemc6i3 = Item(user_id=1, name="Pimento and cheese",
             description="Simple and affordable.", category=category6)

session.add(itemc6i3)
session.commit()

# Add Category 7 for the item catalog project
category7 = Category(user_id=1, name="Pizza Plus")

session.add(category7)
session.commit()

# Add Item 1 under Catalog 7 for the item catalog project
itemc7i1 = Item(user_id=1, name="Cheese Pizza",
...
itemc7i2 = Item(user_id=1, name="Pepperoni Pizza",
